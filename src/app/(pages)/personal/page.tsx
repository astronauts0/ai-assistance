        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-12">
          <div className="flex flex-col">
            ...
            <input
              ...
              type="text"
              required
              className="bg-[#A72EFF33] p-3 rounded-md text-white"
            />
          </div>
          ...
          <div className="flex justify-center items-center col-span-full mt-6">
            <button
              type="submit"
              className="bg-white text-black py-3 px-14 flex items-center gap-1 rounded-md font-semibold hover:bg-white/90 transition-colors duration-300"
            >
